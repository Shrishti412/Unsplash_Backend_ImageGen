...
const url = 'mongodb+srv://$_USERNAME_$:$_PASSWORD_$@cluster0.54uq7sv.mongodb.net/$_DB_NAME_$?retryWrites=true&w=majority&appName=Cluster0';

const databaseUser = 'shrishti';
const databasePassword = 'test';
const databaseName = 'gen';
